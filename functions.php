...
function ubuntuTheme_widgets() {
	...
	register_sidebar(
		array(
			'before_title'  => '',
			'after_title'   => '',
			'before_widget' => '<div class="image-gallery">',
			'after_widget'  => '</div>',
			'name'          => 'image-gallery-home',
			'id'            => 'image-gallery-home',
			'description'   => 'home page image gallery'
		)
	);
	...
	register_sidebar(
		array(
			...
			'before_widget' => '<div>',
			'after_widget'  => '</div>',
			'name'          => 'footer-guestbook',
			'id'            => 'footer-guestbook',
			'description'   => 'footer guestbook'
		)
	);
}
